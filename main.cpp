...
bool useSeedProvidedAsInput = false;//If this is set to TRUE, instead of calulating the maxSeed and using that as the seed, we use the nodes provided by the user in a text file as the seed. You will have to manually set the file name in the code
        ...
        if (useRandomSeed) {
            ...
            if (useEnvelop) {
                ...
                envelopedNodes = getSeed((budget + 100), maxSeedGraph, activatedSet, set<int>(), set<int>(), set<int>(),
                                         set<int>(), NULL);    //Find the top (budget + 100) nodes that will form a part of the envelop
            }
